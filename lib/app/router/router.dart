...
class AppRoutes {
  ...
  static const String settingsNotification = '/claws/settings/notification';
  static const String settingsDnd = '/claws/settings/dnd';
  static const String settingsBiometric = '/claws/settings/biometric';
